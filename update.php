...
$file_size = retrieve_remote_file_size( "https://docs.google.com/spreadsheet/pub?key=0Ai1AAPpLHFnLdHRldDNHOE1ncks5Qnl5Um82RWhjdmc&single=true&gid=140&output=csv" );
//echo $file_size."<br />";

$localfile= filesize("prato.csv");
//echo $localfile;
...
$url = 'https://docs.google.com/spreadsheet/pub?key=0Ai1AAPpLHFnLdHRldDNHOE1ncks5Qnl5Um82RWhjdmc&single=true&gid=140&output=csv';
$file = "prato.csv";
$fileok = "prato1.csv";
$fileok1 = "prato2.csv";
$fileok2 = "prato3.csv";
